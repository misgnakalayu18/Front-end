...
interface InitialState {
  ...
  saleModel: { open: boolean, data: null | SaleModalData },
  bulkDelete: string[]
}
...
const modalSlice = createSlice({
  ...
  reducers: {
    ...
    toggleSaleModel: (state, action: PayloadAction<{ open: boolean, data: null | SaleModalData }>) => {
